<?php
/* Welcome to beekman :)
This is the core beekman file where most of the
...
function beekman_head_cleanup()  {
	...
	add_filter( 'style_loader_src', 'beekman_remove_wp_ver_css_js', 9999 );
	// remove Wp version from scripts
	add_filter( 'script_loader_src', 'beekman_remove_wp_ver_css_js', 9999 );

} /* end beekman head cleanup */
...
function beekman_rss_version() { return ''; }

// remove WP version from scripts
function beekman_remove_wp_ver_css_js( $src ) {
	if ( strpos( $src, 'ver=' ) )
...
function beekman_remove_wp_widget_recent_comments_style() {
...
function beekman_remove_recent_comments_style() {
...
function beekman_gallery_style($css) {
...
function beekman_scripts_and_styles() {
...
function beekman_theme_support() {
...
// Related Posts Function (call using beekman_related_posts(); )
function beekman_related_posts() {
	echo '<ul id="beekman-related-posts">';
	global $post;
	...
	wp_reset_postdata();
	echo '</ul>';
} /* end beekman related posts function */
...
function beekman_filter_ptags_on_images($content){
