...
- moving beekman ahoy function to main functions file
...
- removed "Powered by Wordpress & beekman" from footer, because let's face it: we all delete this anyway.
...
- removed default "beekman" text in footer if you don't have a menu
...
- added beekman body class depending on what browser
...
- added post formats to beekman.php core
...
- fixed error in beekman.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the beekman file so it's easier to see what's being
	called.
